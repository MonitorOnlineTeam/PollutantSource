...
export default class Marquee extends Component {
  ...
  renderLandscapeMarquee() {
    ...
    return (
      <div className={styles["marquee-landscape-wrap"]} ref={(mw) => { this.domMw = mw; }}>
        <div className={styles["marquee-landscape-item"]} ref={(mi) => { this.domMi = mi; }}>
          {loopData.map((item, index) => (<div className={styles["marquee-landscape-txt"]} key={index}>{item.txt}</div>))}
        </div>
        <div className={styles["marquee-landscape-item"]}>
          {loopData.map((item, index) => (<div className={styles["marquee-landscape-txt"]} key={index}>{item.txt}</div>))}
        </div>
      </div>
    )
  ...
  renderVerticalMarquee() {
    ...
    return (
      <div className={styles["marquee-vertical-wrap"]} ref={(mw) => { this.domMw = mw; }}>
        <div className={styles["marquee-vertical-item"]} ref={(mi) => { this.domMi = mi; }}>
          {loopData.map((item, index) => (<div style={{  lineHeight: verticalItemHeight }} className={styles["marquee-vertical-txt"]} key={index}>{item.txt}</div>))}
        </div>
        <div className={styles["marquee-vertical-item"]}>
          {loopData.map((item, index) => (<div style={{lineHeight: verticalItemHeight }} className={styles["marquee-vertical-txt"]} key={index}>{item.txt}</div>))}
        </div>
      </div>
    )
  ...
  render() {
    ...
    return (
      <div className={styles["react-marquee-box"]}>
