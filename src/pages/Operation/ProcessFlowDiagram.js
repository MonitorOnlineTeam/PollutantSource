...
export default class ProcessFlowDiagram extends Component {
    ...
    render() {
        const { flows, loading, operationInfo, stateInfo, paramsInfo, dataInfo, paramstatusInfo, pollutantTypelist, treedataloading, datalist, pollutantTypeloading } = this.props;
