...
import BdTestRecordContent from './BdTestRecordContent';

@connect()
class BdTestRecord extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
    ...
    render() {
        return (
            <MonitorContent {...this.props} breadCrumbList={this.renderBreadCrumb()}>
                ...
                >
                    <BdTestRecordContent TaskID={this.props.match.params.TaskID} />
                </Card>
            </MonitorContent>
        );
    }
}
export default BdTestRecord;