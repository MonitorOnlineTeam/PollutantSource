...
export default Model.extend({
    ...
    effects: {
        ...
        * addPoint({ payload }, { call, put, update, select }) {
            ...
            let result = yield call(services.postAutoFromDataAdd, { ...payload, FormData: JSON.stringify(payload.FormData) });
        ...
        * delPoint({ payload }, { call, put, update, select }) {
            ...
            let result = yield call(services.postAutoFromDataDelete, { configId: payload.configId, FormData: JSON.stringify(pointParam) });
