...
import { loadPollutantType, loadPollutant, loadMonitoroverView, loadCountryPointView, querycountrycombox } from '../services/api';
...
export default Model.extend({
    ...
    effects: {
        ...
        * querycountrydata({payload}, {
            call, update
        }) {
            const result = yield call(querycountrycombox, payload);
            yield update({ CouontryInfo: result.data });
        }
    },
    subscriptions: {
