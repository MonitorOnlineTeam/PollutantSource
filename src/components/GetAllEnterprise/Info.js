...
class Info extends PureComponent {
                                ...
                                callback: (result) => {
                                    if (result.requstresult === '1') {
                                        this.setState({
                                            ...
                                            message.success("添加成功", 3).then(() => dispatch(routerRedux.push(`/BasicInfo/enterprisemanageedit/${result.reason}`)));
                                        });
                                    } else {
                                ...
                                callback: (result) => {
                                    if (result.requstresult === '1') {
                                        this.setState({
                                            ...
                                            message.success("修改成功", 3).then(() => dispatch(routerRedux.push(`/BasicInfo/enterprisemanageedit/${result.reason}`)));
                                        });
                                    } else {
                                        message.err(result.reason);
    ...
    GetData() {
        ...
        this.props.form.setFieldsValue({
            ...
            TargetCoordinateSet: `${this.child.props.form.getFieldValue('polygon')}`
        });
    }
                ...
                <Form layout="inline" className={this.state.className} style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    {/* <FormItem style={{ width: '400px' }} {...formItemLayout} label="所属行业">
                        {getFieldDecorator('TargetIndustryTypeCode', {
                            ...
                            <Select style={{ width: 300 }} disabled={isedit} onChange={this.industry}>
                    ...
                    <FormItem style={{ width: '400px' }} {...formItemLayout} label="厂界">
                        {getFieldDecorator('TargetCoordinateSet', {
                            ...
                            <TextArea style={{ width: 300 }} disabled={isedit} rows={4} />
                        )}
                    </FormItem>
                </Form>
            );
                        ...
                        <Col xs={{ span: 9, offset: 1 }} >
                            ...
                            <div className={styles.antCss} >
                                ...
                                <Modal
                                    ...
                                    width={1000}
                                >
                                    <ImgInfo imagelist={ImgList !== null && ImgList !== "" && ImgList !== undefined ? ImgList : ''} uuid={baseinfo !== null && baseinfo !== "" && baseinfo !== undefined ? baseinfo.TargetPhoto : ''} TargetCode={baseinfo !== null && baseinfo !== "" && baseinfo !== undefined ? baseinfo.TargetCode : ''} path={'/BasicInfo/enterprisemanageedit/' + this.props.match.params.ID} />
                                </Modal>
