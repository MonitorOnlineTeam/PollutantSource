...
import DirectMeasurementRecordContent from './DirectMeasurementRecordContent';
...
class DirectMeasurementRecord extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
    ...
    render() {
        return (
            ...
            >
                ...
                >
                    <DirectMeasurementRecordContent TaskID={this.props.match.params.TaskID} />
                </Card>
            </MonitorContent>
        );
    }
}
export default DirectMeasurementRecord;
