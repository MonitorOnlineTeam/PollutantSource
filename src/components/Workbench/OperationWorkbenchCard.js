    ...
    render() {
        ...
        return (
            <WorkbenchCard title={<span>运维提醒 | <a href="http://www.baidu.com" target="_blank" style={{color: 'red', fontWeight: 'bold'}}>{titleCnt2}</a></span>}
                ...
                <Switch style={{marginLeft: 5}} onChange={this.onSwitchChange} checkedChildren="催办" unCheckedChildren="全部" defaultChecked={false} /> <Button shape="circle" icon="search" id="btn1" onClick={this.search} />
                </div>} />
        );
    }
}
