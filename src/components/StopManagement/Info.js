                        ...
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                ...
                                {getFieldDecorator('title', {
                                    ...
                                    ]} width="300px" cascadeSize={2} onItemClick={true} disabled={true}  />
                                )}
                            </FormItem>
                        </Col>
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                ...
                                {getFieldDecorator('stopmode')(
                                    <RadioGroup onChange={this.onChange} disabled={true}>
                        ...
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                ...
                                {getFieldDecorator('excepttime', {
                                    ...
                                    <RangePicker_ style={{width: 350}} disabled={true} format="YYYY-MM-DD HH:mm:ss" onChange={this._handleDateChange1} dateValue={this.state.exceptrangeDate} />
                                )}
                            </FormItem>
                        </Col>
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                ...
                                {getFieldDecorator('realtime', {
                                    ...
                                    <RangePicker_ style={{width: 350}} disabled={true} format="YYYY-MM-DD HH:mm:ss" onChange={this._handleDateChange2} dateValue={this.state.realrangeDate} />
                                )}
                            </FormItem>
                        </Col>
                    </Row>
                        ...
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                ...
                                {getFieldDecorator('timespan', {
                                    ...
                                    <span>
                                        <InputNumber min={1} disabled={true} onChange={this.onChange} style={{ width: '65%', float: 'left', marginRight: '3%' }} /><Select
                                            style={{ width: '32%', float: 'left' }}
                                            onChange={this.handleCurrencyChange} disabled={true}
                                        >
                        ...
                        <Col xs={2} sm={6} md={24} lg={24} xl={24} xxl={24}>
                            <FormItem
                                ...
                                {getFieldDecorator('description')(
                                    <TextArea disabled={true} rows={4} style={{width: '100%'}} value={this.state.description} />
                                )}
                            </FormItem>
                        </Col>
                    </Row>
