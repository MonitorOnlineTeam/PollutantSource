...
const gaodeMapSdk = 'http://webapi.amap.com/maps?v=1.3&key=ffc790cda6d6a9d0204678ca68d119e1&plugin=AMap.Autocomplete,AMap.PlaceSearch,AMap.MouseTool';
...
class JsAamp extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            status: 0
