            ...
            <MapInteractionCSS>
                <div className={styles.FormDiv} style={{ height: SCREEN_HEIGHT }}>
                    ...
                    <table className={styles.FormTableBottom}>
                        <tbody>
                            <tr>
                                <td style={{ width: '65%', height: '25px', textAlign: 'right', fontWeight: 'bold', minWidth: 800 }}>负责人签名：</td>
                                <td style={{ width: '35%', height: '25px', minWidth: 100 }}>{DataLength === 0 ? null : Data.Record.length === 0 ? null : Data.Record.SignContent === null ? null : <img style={{ width: '90px', height: '30px' }} src={SignContent} />}</td>
                            </tr>
                            <tr>
                                <td style={{ width: '65%', height: '25px', textAlign: 'right', fontWeight: 'bold', minWidth: 800 }}>签名时间：</td>
                                <td style={{ width: '35%', height: '25px', fontSize: '10px', minWidth: 150 }}>{SignTime}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
