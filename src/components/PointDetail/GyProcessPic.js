                ...
                { isloading ? <Spin style={{width: '100%',
                    ...
                    : <MapInteractionCSS
                        ...
                        <div className={styles.imgBg} >
                            ...
                            <div style={{width: '100px', height: '20px', position: 'relative', left: '400px', top: '186px', fontWeight: '700', fontSize: '10px'}}>管线温度：{!flows ? '暂未上传' : flows['系统采样管线温度'] + '°C'}</div>
                            <div style={{width: '100px', height: '20px', position: 'relative', left: '635px', top: '152px', fontWeight: '700', fontSize: '10px'}}>制冷温度：{!flows ? '暂未上传' : flows['系统冷凝器温度'] + '°C'}</div>
                            <div style={{width: '100px', height: '20px', position: 'relative', left: '720px', top: '172px', fontWeight: '700', fontSize: '10px'}}>电磁阀：{!flows ? '暂未上传' : flows.Jldcf}</div>
                            <div style={{width: '90px', height: '20px', position: 'relative', left: '890px', top: '160px', fontWeight: '700', fontSize: '10px'}}>下次更换时间：{!flows ? '  暂未上传' : flows['取样泵']}</div>
                            ...
                            <div style={{width: '100px', height: '20px', position: 'relative', left: '1070px', top: '225px', fontWeight: '700', fontSize: '10px'}}>下次更换时间：{!flows ? '暂未上传' : flows['过滤器']}</div>
                            <div style={{width: '100px', height: '20px', position: 'relative', left: '860px', top: '240px', fontWeight: '700', fontSize: '10px'}}>下次更换时间：{!flows ? '暂未上传' : flows['蠕动泵']}</div>
                            <div style={{width: '120px', height: '20px', position: 'relative', left: '720px', top: '275px', fontWeight: '700', fontSize: '10px'}}>滤芯下次更换时间：{!flows ? '暂未上传' : flows['调节阀滤芯']}</div>
                            <div style={{width: '120px', height: '20px', position: 'relative', left: '320px', top: '105px', fontWeight: '700', fontSize: '10px'}}>滤芯下次更换时间：{!flows ? '暂未上传' : flows['探头滤芯']}</div>
                            ...
                            <div style={{width: '120px', height: '20px', position: 'relative', left: '367px', top: '-120px', fontWeight: '700', fontSize: '10px'}}>探头温度：{!flows ? '暂未上传' : flows['系统采样探头温度'] + '°C'}</div>
                            <div style={{width: '120px', height: '20px', position: 'relative', left: '367px', top: '-120px', fontWeight: '700', fontSize: '10px'}}>工作状态：{!flows ? '暂未上传' : flows['工作状态']}</div>
                            <div style={{width: '120px', height: '20px', position: 'relative', left: '527px', top: '-30px', fontWeight: '700', fontSize: '10px'}}>截止阀状态：{!flows ? '暂未上传' : flows['截止阀故障']}</div>
                            <div style={{width: '120px', height: '20px', position: 'relative', left: '207px', top: '-145px', fontWeight: '700', fontSize: '10px'}}>压差：{!flows ? '暂未上传' : flows['压差']}</div>
                            <div style={{width: '120px', height: '20px', position: 'relative', left: '207px', top: '-145px', fontWeight: '700', fontSize: '10px'}}>皮托管吹扫：{!flows ? '暂未上传' : flows['皮托管吹扫']}</div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs01_截距']?flows['zs01_截距']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style={{width: '40%', textAlign: 'center'}}>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs01_斜率']?flows['zs01_斜率']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                                <tr style={{border:'none'}}>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs01_测量量程']?flows['zs01_测量量程']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table className={styles.FormTable}>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs02_截距']?flows['zs02_截距']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style={{width: '40%', textAlign: 'center'}}>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs02_斜率']?flows['zs02_斜率']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                                <tr  style={{border:'none'}}>
                                                    <td style={{width: '40%', textAlign: 'center'}}>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs02_测量量程']?flows['zs02_测量量程']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                                {
                                        ...
                                        <table className={styles.FormTable}>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs03_截距']?flows['zs03_截距']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style={{width: '40%', textAlign: 'center'}}>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs03_斜率']?flows['zs03_斜率']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                                <tr style={{border:'none'}}>
                                                    <td style={{width: '40%', textAlign: 'center'}}>
                                                    ...
                                                    <td style={{width: '60%', textAlign: 'center'}}>
                                                       { flows?(flows['zs03_测量量程']?flows['zs03_测量量程']:'暂未上传'):'暂未上传'}
                                                    </td>
                                                </tr>
                                                {
