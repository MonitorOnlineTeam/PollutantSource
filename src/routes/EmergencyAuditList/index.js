...
import {Button, Table, Select, Card, Form, Row, Col, Icon, message, Progress} from 'antd';
        ...
        const EColumn = [
            {
                ...
                align: 'center',
                render: () => { return <Progress percent={75} status={'active'} strokeWidth={6} style={{ width: 180 }} />; }
            }
        ];
