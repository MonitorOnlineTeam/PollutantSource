...
/**
 * 【排放量】根据因子获取所有月份的排放总量 
 * @params {"pollutantCodes":["02"],"beginTime":"2018-11-01 00:00:00","endTime":"2018-11-30 00:00:00"}
 */
export async function GetAllEntMonthPollutantEmissions(params) {
    const body = {
        pollutantCodes: params.pollutantCodes,
        beginTime: params.beginTime,
        endTime: params.endTime,
    ...
    const result = post('/api/rest/PollutantSourceApi/DataStatistics/GetAllEntMonthPollutantEmissions', body, null);
...
/**
 * 【排放量】根据因子、月份获取所有企业的排放总量 
 * @params {"enterpriseCodes":["3cbfa1f4-3e0a-473b-aab0-5a9a168010ee"] ,"pollutantCodes":["02"],"monthTime":"2018-11-01 00:00:00"}
 */
export async function GetEntMonthAllPointEmissions(params) {
    const body = {
        pollutantCodes: params.pollutantCodes,
        monthTime: params.monthTime,
        emissionsSort: params.emissionsSort,
    ...
    const result = post('/api/rest/PollutantSourceApi/DataStatistics/GetEntMonthAllPointEmissions', body, null);
