...
class OverViewMap extends PureComponent {
    ...
    treeCilck = (row) => {
        ...
        const pollutantInfoList=mainpoll.find(value=>value.pollutantCode==this.state.pollutantTypeCode);
              ...
              <div style={{ marginLeft: 10, marginTop: 10 }}>
                  ...
                  <div style={{ marginTop: 5 }}>
                      <TreeCard
                          ...
                          getHeight="calc(100vh - 260px)"
                          getStatusImg={this.getStatusImg}
                          isloading={treedataloading}
                          getNowPollutantType={this.getNowPollutantType}
                          treeCilck={this.treeCilck}
                      ...
                      />
                      <TreeCardContent
                          style={{overflow:'auto',width:400,background:'#fff'}}
                          ...
                          treeCilck={this.treeCilck}
                          treedatalist={datalist}
                          PollutantType={this.state.pollutantTypeCode}
                      />
                  </div>
              </div>);
      }
          ...
          <div style={{ marginLeft: 10, marginTop: 10,overflow:'auto' }}>
              <div>
                  <TreeDetailStatus
                      ...
                      statusImg={statusImg}
                      pdShow={this.pdShow}
                      detailtime={this.props.detailtime}
                      stationClick={this.stationClick}
                      backTreeList={this.backTreeList}
                      pointName={pointName}
                      detailed={detailed}
                  />
              </div>
              <div style={{ height: 'calc(100vh - 215px)' }} className={styles.detailInfo}>
                  ...
                  <div style={{marginTop: 15}}>
                      <MapPollutantDetail
                            ...
                            detialTreeClick={this.detialTreeClick}
                            detailpcol={detailpcol}
