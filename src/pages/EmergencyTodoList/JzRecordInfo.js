...
export default class JzRecordInfo extends Component {
    ...
    renderBreadCrumb = () => {
        ...
        if (listUrl === 'menu') {
            rtnVal.push({ Name: '零点量程偏移与校准记录表', Url: `/qualitycontrol/jzhistoryrecords` });
        }
        return rtnVal;
    }
                        ...
                        <table className={styles.FormTable}>
                            <tbody>
                                <tr>
                                    ...
                                    <td style={{ width: '13%', height: '30px', border: '0' }}><img style={{ width: '50%', height: '110%' }} src={SignContent} /></td>
                                </tr>
                                <tr>
