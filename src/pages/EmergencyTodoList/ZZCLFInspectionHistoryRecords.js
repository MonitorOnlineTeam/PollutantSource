...
import {routerRedux} from 'dva/router';
    ...
    */
export default class ZZCLFInspectionHistoryRecords extends Component {
        constructor(props) {
            super(props);
            this.state = {
        ...
        seeDetail=(record) => {
            this.props.dispatch(routerRedux.push(`/OperationForm/DirectMeasurement/${record.TaskID}/${record.TypeID}`));
        }
