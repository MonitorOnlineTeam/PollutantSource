...
import styles from '../EmergencyTodoList/WQCQFInspectionHistoryRecords.less';
...
export default class WQCQFInspectionHistoryRecords extends Component {
        ...
        seeDetail=(record) => {
            this.props.dispatch(routerRedux.push(`/pointdetail/${this.props.match.params.pointcode}/CompleteExtraction/${record.TaskID}/${record.TypeID}`));
        }
