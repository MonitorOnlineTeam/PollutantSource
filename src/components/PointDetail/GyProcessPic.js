        ...
        return (
            <div className={styles.GyProcessPic} style={{height: 'calc(100vh - 225px)'}}>
                <div className={styles.imgBg} >
                    ...
                    <div style={{width: '120px', height: '20px', position: 'relative', left: '800px', top: '245px', fontWeight: '700', fontSize: '10px'}}><span className={flows.length === 0 ? styles.AlarmCommon : (flows[0].Status !== '0' ? styles.shine_red : styles.AlarmCommon)}>{flows.length === 0 ? '' : flows[0].ZlqAlarm}</span></div>
