...
import YsyRealVideoData from '../../components/Video/YsyRealVideoData';
                            ...
                            <Card className={styles.card}>
                                ...
                                >
                                    <TabPane tab="实时" key="1">
                                        <Row>
                                            <Col className={styles.gutterleft} span={8} style={{display:this.state.displayRStartBtn}}>
                                                <Tooltip placement="top" title="开始播放">
                                                    <Button type="primary" shape="circle" icon="play-circle" size="Small" onClick={this.btnClick.bind(this,1)} />
                                                </Tooltip>
                                                <a style={{marginLeft:'10px'}} onClick={this.btnClick.bind(this,1)}>开始播放</a>
                                            </Col>
                                            <Col className={styles.gutterleft} span={8} style={{display:this.state.displayREndBtn}}>
                                                <Tooltip placement="top" title="暂停播放">
                                                    <Button type="danger" shape="circle" icon="pause-circle" size="Small" onClick={this.btnClick.bind(this,2)} />
                                                </Tooltip>
                                                <a style={{marginLeft:'10px',color:"red"}} onClick={this.btnClick.bind(this,2)}>暂停播放</a>
                                            </Col>
                                            <Col className={styles.gutterleft} span={8}>
                                                <Tooltip placement="top" title="刷新视频">
                                                    <Button type="primary" shape="circle" icon="redo" size="Small" onClick={this.btnClick.bind(this,1)} />
                                                </Tooltip>
                                                <a style={{marginLeft:'10px'}} onClick={this.btnClick.bind(this,1)}>刷新视频</a>
                                            </Col>
                                            <Col className={styles.gutterleft} span={8}>
                                                <Tooltip placement="top" title="抓取图片">
                                                    <Button type="dashed" shape="circle" icon="file-image" size="Small" onClick={this.btnClick.bind(this,3)} />
                                                </Tooltip>
                                    ...
                                    <TabPane tab="历史" key="2">
                                        ...
                                        <Divider dashed={true} />
                                        <Row>
                                            <Col className={styles.gutterleft} span={8} style={{display:this.state.displayHStartBtn}}>
                                                <Tooltip placement="top" title="开始播放">
                                                    <Button type="primary" shape="circle" icon="play-circle" size="Small" onClick={this.backplay.bind(this)} />
                                                </Tooltip>
                                                <a style={{marginLeft:'10px'}} onClick={this.backplay.bind(this)}>开始播放</a>
                                            </Col>
                                            <Col className={styles.gutterleft} span={8} style={{display:this.state.displayHEndBtn}}>
                                                <Tooltip placement="top" title="暂停播放">
                                                    <Button type="danger" shape="circle" icon="pause-circle" size="Small" onClick={this.backbtnClick.bind(this,2)} />
                                                </Tooltip>
                                                <a style={{marginLeft:'10px',color:"red"}} onClick={this.backbtnClick.bind(this,2)}>暂停播放</a>
                                            </Col>
                                            <Col className={styles.gutterleft} span={8}>
                                                <Tooltip placement="top" title="刷新视频">
                                                    <Button type="primary" shape="circle" icon="redo" size="Small" onClick={this.backplay.bind(this)} />
                                                </Tooltip>
                                                <a style={{marginLeft:'10px'}} onClick={this.backplay.bind(this)}>刷新视频</a>
                                            </Col>
                                            <Col className={styles.gutterleft} span={8}>
                                                <Tooltip placement="top" title="抓取图片">
                                                    <Button type="dashed" shape="circle" icon="file-image" size="Small" onClick={this.backbtnClick.bind(this,3)} />
                                                </Tooltip>
                                                <a style={{marginLeft:'10px',color:"black"}} onClick={this.backbtnClick.bind(this,3)}>抓取图片</a>
                                            </Col>
                                        </Row>
                                        ...
                                        <Row gutter={48} style={{display:this.state.displayH}}>
                                            <Col xl={24} lg={24} md={24} sm={24} xs={24}>
                                                {
                                                    this.state.displayR&&<HistoryVideo onRef={this.onRef1} {...this.props} beginDate={moment(this.state.startdateString,'YYYY-MM-DD HH:mm:ss')} endDate={moment(this.state.enddateString,'YYYY-MM-DD HH:mm:ss')} />
                                                }
